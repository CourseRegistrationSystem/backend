...
aedes.authenticate = function (client, username, password, callback) {
  ...
  if (
    username === AuthApp.username &&
    password.toString() === AuthApp.password
  ) {
    // console.log('OK')
  ...
  if (
    ...
    password.toString() === AuthServer.password
  ) {
    // console.log('OK')
    client.Profile = {
      subscribe: AuthServer.subscribe,
      publish: AuthServer.publish,
    };
    return callback(null, true);
  }
